...
class DualStreamRiceModel(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.backbone_s1 = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.DEFAULT)
        ...
        self.backbone_s2 = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.DEFAULT)
...
if __name__ == '__main__':
    model = DualStreamRiceModel()
    dummy_s1 = torch.randn(2, 3, 64, 64) 
    dummy_s2 = torch.randn(2, 3, 64, 64) 
    output = model(dummy_s1, dummy_s2)
